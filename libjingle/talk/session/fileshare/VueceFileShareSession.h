...
#ifndef VUECE_FILE_SHARE_SESSION_H__
#define VUECE_FILE_SHARE_SESSION_H__
...
public:
  ...
  VueceFileShareSession(cricket::Session* session, const std::string &user_agent, bool bPreviewNeeded_);
  virtual ~VueceFileShareSession();

  bool IsComplete() const;
  bool IsClosed() const;
  FileShareState state() const;
  sigslot::signal2<cricket::VueceFileShareSession*, cricket::FileShareState> SignalState;
  sigslot::signal1<cricket::VueceFileShareSession*> SignalNextFile;
  sigslot::signal1<cricket::VueceFileShareSession*> SignalUpdateProgress;
  sigslot::signal5<cricket::VueceFileShareSession*, const std::string&, int, int, talk_base::HttpServerTransaction*> SignalResampleImage;
  sigslot::signal4<cricket::VueceFileShareSession*, const std::string&, int, int> SignalPreviewReceived;
...
//  talk_base::HttpClient* http_client_preview;
...
#endif  // VUECE_FILE_SHARE_SESSION_H__
