...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-nonfree --enable-libxvid --enable-libmp3lame --enable-libfaac --enable-shared
prefix=/usr/local
...
EXTRALIBS=-ldl -lxvidcore -lmp3lame -lfaac -lm -pthread -lz -lrt 
INSTALL=install
LIBTARGET=
