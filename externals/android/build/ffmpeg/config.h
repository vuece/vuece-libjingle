...
#define HAVE_LOG2 1
//set to 0 by Vuece, this is no log2f in Android, need to add the impl by yourself
//see x264 project osdep.h for an example
#define HAVE_LOG2F 0
...
#define CONFIG_AAC_DECODER 1 //set to 1 by Vuece
...
//manually added by Vuece after upgrade
